...
# Total sites in supercell: 16
# Parallel runs per concentration: 5
# Maximum concurrent jobs: 4
# Concentrations: [0.125, 0.5, 0.875, 0.375]
...
echo "🔍 Concentrations to be searched: [0.125, 0.5, 0.875, 0.375]"
...
run_concentration() {
    ...
    local current_run=$2
    local total_runs=$3
    local sweep_atoms=$(printf "%.0f" $(echo "$conc * 16" | bc))
    local comp_atoms=$(echo "16 - $sweep_atoms" | bc)
    ...
    cat > rndstr.in << EOF
1.000000 1.000000 1.000000 60.00 60.00 60.00
1 0 0
0 1 0
0 0 1
0.750000 0.750000 0.750000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.500000 0.500000 0.500000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.125000 0.125000 0.625000 Fe
0.125000 0.625000 0.125000 Fe
0.125000 0.125000 0.125000 Fe
0.625000 0.125000 0.125000 Fe
0.365331 0.904007 0.365331 O
0.365331 0.365331 0.365331 O
0.904007 0.365331 0.365331 O
0.884669 0.884669 0.345993 O
0.345993 0.884669 0.884669 O
0.884669 0.884669 0.884669 O
0.365331 0.365331 0.904007 O
0.884669 0.345993 0.884669 O
EOF
