...
# Concentration sweep script for Zn-Mn system
# Generated by SimplySQS
# Corrdump command: corrdump -l=rndstr.in -ro -noe -nop -clus -2=1.1 -3=1.0
# Total sites in supercell: 8
# Parallel runs per concentration: 7
# Maximum concurrent jobs: 6
# Concentrations: [0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875]
# Total estimated time: 140.0 minutes

set -e

SWEEP_ELEMENT="Zn"
COMPLEMENT_ELEMENT="Mn"
TIME_PER_CONC_DEFAULT=20.0
MAX_PARALLEL=6
PARALLEL_RUNS_PER_CONC_DEFAULT=7
CORRDUMP_CMD="corrdump -l=rndstr.in -ro -noe -nop -clus -2=1.1 -3=1.0"
...
echo "🔍 Concentrations to be searched: [0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875]"
...
try:
    ...
    comment = "SQS ZnMn conc=$conc from $bestsqs_file"
...
run_concentration() {
    ...
    local current_run=$2
    local total_runs=$3
    local sweep_atoms=$(printf "%.0f" $(echo "$conc * 8" | bc))
    local comp_atoms=$(echo "8 - $sweep_atoms" | bc)
...
0 1 0
0 0 1
0.000000 0.500000 0.500000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.000000 0.000000 0.000000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.500000 0.000000 0.500000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.500000 0.500000 0.000000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.250000 0.250000 0.250000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.750000 0.250000 0.750000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.750000 0.750000 0.250000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.250000 0.750000 0.750000 ${SWEEP_ELEMENT}=$conc,${COMPLEMENT_ELEMENT}=$comp_conc
0.375000 0.125000 0.875000 Fe
0.625000 0.375000 0.375000 Fe
0.125000 0.625000 0.125000 Fe
0.875000 0.875000 0.625000 Fe
0.875000 0.375000 0.125000 Fe
0.375000 0.625000 0.375000 Fe
0.125000 0.125000 0.625000 Fe
0.625000 0.875000 0.875000 Fe
0.125000 0.875000 0.375000 Fe
0.375000 0.375000 0.625000 Fe
0.625000 0.125000 0.125000 Fe
0.875000 0.625000 0.875000 Fe
0.875000 0.125000 0.375000 Fe
0.375000 0.875000 0.125000 Fe
0.125000 0.375000 0.875000 Fe
0.625000 0.625000 0.625000 Fe
0.888650 0.611350 0.111350 O
0.111350 0.888650 0.611350 O
0.611350 0.111350 0.888650 O
0.388650 0.388650 0.388650 O
0.361350 0.138650 0.638650 O
0.638650 0.361350 0.138650 O
0.861350 0.861350 0.861350 O
0.138650 0.638650 0.361350 O
0.361350 0.638650 0.138650 O
0.138650 0.361350 0.638650 O
0.638650 0.138650 0.361350 O
0.888650 0.111350 0.611350 O
0.611350 0.888650 0.111350 O
0.111350 0.611350 0.888650 O
0.111350 0.388650 0.111350 O
0.611350 0.611350 0.388650 O
0.388650 0.888650 0.888650 O
0.638650 0.861350 0.638650 O
0.861350 0.361350 0.361350 O
0.138650 0.138650 0.861350 O
0.138650 0.861350 0.138650 O
0.638650 0.638650 0.861350 O
0.611350 0.388650 0.611350 O
0.111350 0.111350 0.388650 O
0.388650 0.611350 0.611350 O
0.888650 0.388650 0.888650 O
0.861350 0.138650 0.138650 O
0.361350 0.861350 0.361350 O
0.861350 0.638650 0.638650 O
0.388650 0.111350 0.111350 O
0.888650 0.888650 0.388650 O
0.361350 0.361350 0.861350 O
EOF
